...
# WaveLab Services
This project was created using the WIM services wavelab. The WIM Services wavelab usage is outlined below:
## Installation of wavelab
[WIM.Services.WaveLab NuGet package](https://www.nuget.org/packages/WIM.Services.WaveLab/):`dotnet new -i WIM.Services.WaveLab`
